...
0	0	0.00679289	0.0996938	0.290321	0.473315	0.616078	0.720451	0.794407	0.845819	0.881115	0.90515	0.921427	0.932413	0.93981	0.944784	0.948124	0.950366	0.951871	0.95288	0.953845
...
# bnd  bnd value  mean      type  SD  phase var dev minyr maxyr SD  design  switch
  0.05 0.4 0.22   -1.609438 3     0.1   4 0 0 0 0 0 0 0 # M

### Growth parameters ignored in empirical input approach
2     15   10     32  -1  99  -5  0 0 0 0 0 0 0 # A1
15    75   55    50  -1  99  -3  1 0 0 0 0 0 0 # Linf with link to environmental variable 1
0.2   0.4  0.40  0.3 -1  99  -3  2 0 0 0 0 0 0 # VBK with link to environmental variable 2
0.03  0.16 0.1   0.1 -1  99  -5  0 0 0 0 0 0 0 # CV of length at age 0
0.03  0.2  0.1   0.1 -1  99  -5  0 0 0 0 0 0 0 # CV of length at age inf
# W-L, maturity and fecundity parameters
-3  3 7.0E-06 7.0E-06 -1  99  -50 0 0 0 0 0 0 0 # F W-L slope
-3  3 2.95  2.9624  -1  99  -50 0 0 0 0 0 0 0 # F W-L exponent
# Maturity
-3  43  34 36.89 -1  99  -50 0 0 0 0 0 0 0 # L at 50% maturity
-3  3 -0.18 -0.48 -1  99  -50 0 0 0 0 0 0 0 # F Logistic maturity slope
...
0.2 1 0.82  0.777 2 0.113 4 # Steepness with Myers' prior
...
#LO  HI    INIT   PRIOR   PR_type SD  PHASE
-3   3     0.0     0.0     -1     99  -5 # Q_base_1_Fishery
-3   3     0.0     0.0     -1     99  -5 # Q_base_1_Survey
...
# A B C D
# Size selectivity
24  0 0 0  # Fishery (24=double-normal)
24  0 0 0  # Acoustic_Survey (24=double-normal)
# Age selectivity
10  0 0 0  # Fishery
...
# bnd bnd   value mean  type  SD  phase var dev minyr maxyr SD  design  switch
# Fishery age-based
15      69      52.0    45.0   -1      0.05    1       0   0   0   0   0.5   0   0  #PEAK
...
0 # Do variance/sample size adjustments by fleet
