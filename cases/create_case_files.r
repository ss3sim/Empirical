...
setwd("/Users/peterkuriyama/School/Research/capam_growth/Empirical/cases")
...
#Ask Kot about this
g0 <- c('function_type; change_tv',
         'param; L1',
         'dev; c(rep(0, 50), rep(.05, 50))')
writeLines(g0, paste0('G0-', spp.case[spp], '.txt'))
