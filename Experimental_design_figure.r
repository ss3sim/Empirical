...
plot_experimental_design <- function(){
  par(mar=c(4,4.5,0,1), oma=c(0,0,1,0))
  ...
  #        pt.cex=1.5)
  legend(0, 4.3, legend=c("Data-rich late-survey","Data-rich", "Data-unrealistic"), pch=19, col=ScenPal, bty='n', 
         pt.cex=1.5)
  ...
  plot(1:100, rep(0,100), ylim=c(-1.2,1.5), axes=F, ylab=NA, xlab="Year", pch=19)
  axis(1)
  axis(2, at=c(-1,0,1))
...
png(width = 7, height = 9, units = 'in', res = 200, 
  file = 'figs/experimental_design.png')
